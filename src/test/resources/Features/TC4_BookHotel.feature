...
Feature: Verifying Adactin Book Hotel Page
  ...
  Scenario Outline: Verifying Adactin Book Hotel Page
    ...
    Examples: 
      ...
      | Deepan97 | 12345678 | Adelaide | Hotel Hervey | Super Deluxe | 1 - One | 23/08/2022  | 25/08/2022   | 1 - One       | 0 - None        | deepan     | deep    | Thanjavur        |
...
@BookHotelWithField
  Scenario Outline: Verifying Adactin Book Hotel Page Without Enter Any Fields
    ...
    Examples: 
      ...
      | Deepan97 | 12345678 | Adelaide | Hotel Hervey | Super Deluxe | 1 - One | 23/08/2022  | 25/08/2022   | 1 - One       | 0 - None        |
