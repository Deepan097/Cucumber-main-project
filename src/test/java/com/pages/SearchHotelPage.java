 ...
 * 
 * @author Deepan
 * @description Used to maintain webelement for search hotel page
 * @date 28/08/22
 */
public class SearchHotelPage extends BaseClass {
	...
	/**
	 * @description Used to perform Search hotel with all fields
	 * @param location
	 * @param hotel
	 * @param roomType
	 * @param roomNo
...
/**
 * @description Used to perform search hotel with manditary fields
 * @param location
 * @param roomNos
 * @param checkInDate
 * @param checkOutDate
 ...
 */
	// 4.Verifying Adactin Search Hotel Page With Error Message In Location Field
	// When Without Entering Any Fields
